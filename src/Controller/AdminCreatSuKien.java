 ...
 */
@WebServlet("/AdminCreatSuKien")
public class AdminCreatSuKien extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public AdminCreatSuKien() {
		super();
