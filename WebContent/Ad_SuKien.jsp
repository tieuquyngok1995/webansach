			...
			<div class="container-fluid">
				...
				<ul class="nav nav-tabs">
					...
					<div align="right">
						...
						<a href="AD_CreateSuKien.jsp"> <input type="submit" class="btn btn-info"
							value="Thêm Sự Kiện Mới">
						</a>
					...
					<div id="admin" class="tab-pane fade in active">
						...
						<div class="listadmin">
							<table class="table table-hover">
								...
								<tbody>
									<%
										for (int i = 0; i < SuKienDAO.getListSuKien().size(); i++) {
											String STT = SuKienDAO.getListSuKien().get(i).getSTT();
											 String delete = "AdminDeleteSuKien?STT=" + STT;
											String edit = "AdminInfoSuKien?STT=" + STT; 
									%><tr>
										<td><%=STT%></td>
										<td><%=SuKienDAO.getListSuKien().get(i).getTieuDe()%></td>
										<td><%=SuKienDAO.getListSuKien().get(i).getnDTT()%></td>
										<td><%=SuKienDAO.getListSuKien().get(i).getnDC()%></td>
										<td><%=SuKienDAO.getListSuKien().get(i).getNgayDang()%></td>
