	...
	<div class="container-fluid" style="width: 1099px; height: 1045px;">
		<div class="content">
			<div class="container-fluid">
				<h2>Danh Mục Đơn Hàng Đã Xác Nhận</h2>
					...
					<div id="admin" class="tab-pane fade in active">
						...
						<div class="listadmin">
							<table class="table table-hover">
								...
								<tbody>
									<%
										for (int i = 0; i < DonHangDAO.getListDonHang().size(); i++) {
											String maDH = DonHangDAO.getListDonHang().get(i).getMaDH();
											 String delete = "AdminDeleteDonHang?maDH=" + maDH;
											String edit = "AdminInfoDonHang?maDH=" + maDH; 
									%><tr>
										<td><%=maDH%></td>
										<td><%=DonHangDAO.getListDonHang().get(i).getTenTK()%></td>
										<td><%=DonHangDAO.getListDonHang().get(i).getSanPham()%></td>
										<td><%=DonHangDAO.getListDonHang().get(i).getSoLuong()%></td>
										<td><%=DonHangDAO.getListDonHang().get(i).getDonGia()%></td>
